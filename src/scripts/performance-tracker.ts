...
const PAPER_STAGNATION_REVIEW_TRADES = Math.max(env.PAPER_PROMOTION_MIN_TRADES * 2, 16);
const PAPER_STAGNATION_MIN_WIN_RATE_PCT = Math.max(env.PAPER_PROMOTION_MIN_WIN_RATE_PCT - 2, 58);
const PAPER_STAGNATION_MIN_AVG_PNL_PCT = Math.max(1.5, env.PAPER_PROMOTION_MIN_AVG_PNL_PCT * 0.3);
const PAPER_STAGNATION_MIN_MEDIAN_PNL_PCT = Math.max(0.75, env.PAPER_PROMOTION_MIN_MEDIAN_PNL_PCT * 0.4);
const PAPER_FINAL_STAGNATION_REVIEW_TRADES = Math.max(env.PAPER_PROMOTION_MIN_TRADES * 4, 32);
const PAPER_FINAL_STAGNATION_MIN_WIN_RATE_PCT = Math.max(env.PAPER_PROMOTION_MIN_WIN_RATE_PCT, 60);
const PAPER_FINAL_STAGNATION_MIN_AVG_PNL_PCT = Math.max(3, env.PAPER_PROMOTION_MIN_AVG_PNL_PCT * 0.6);
const PAPER_FINAL_STAGNATION_MIN_MEDIAN_PNL_PCT = Math.max(1.5, env.PAPER_PROMOTION_MIN_MEDIAN_PNL_PCT * 0.75);
